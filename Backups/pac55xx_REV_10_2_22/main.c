...
//#endif
    ...
    volatile uint32_t current_speed = (( PAC55XX_TIMER_SEL->PRD.w >> 5) * (uint32_t)((2)));
        
    
    PAC55XX_TIMER_SEL->CCTR4.CTR = (( PAC55XX_TIMER_SEL->PRD.w >> 5) * (uint32_t)((2)));;
    PAC55XX_TIMER_SEL->CCTR5.CTR = (( PAC55XX_TIMER_SEL->PRD.w >> 5) * (uint32_t)((2)));;
    PAC55XX_TIMER_SEL->CCTR6.CTR = (( PAC55XX_TIMER_SEL->PRD.w >> 5) * (uint32_t)((2)));;
